...
export default function Home() {
    ...
    // Detection stages for progress indicator
    ...
    const simulateProgress = () => {
        ...
        const interval = setInterval(() => {
            ...
            setActiveStep(prev => {
                const newStep = Math.floor((uploadProgress / 100) * 4);
    ...
    // Define validIndices to track indices of non-null image paths in results
    const validIndices = results
        ? results.reduce((acc, path, index) => {
                                    ...
                                    {processingSteps.map((step, index) => (
                                        ...
                                        >
                                            ...
                                            <p className={`text-xs mt-2 font-medium ${
                                                index <= activeStep ? 'text-cyan-400' : 'text-gray-500'
                                            }`}>
                                                {step}
                                            </p>
                                            ...
                                            {index < processingSteps.length - 1 && (
                                                <div className="absolute left-full top-4 w-full h-0.5 -translate-y-1/2">
                                                    <div className={`h-full ${
                                                        index < activeStep ? 'bg-gradient-to-r from-cyan-500 to-blue-500' : 'bg-gray-800'
                                                    }`} style={{ width: `${index < activeStep ? '100%' : '0%'}` }}></div>
                                                </div>
                                            )}
                                        </div>
                                    ))}
                                ...
                                <label
                                    ...
                                    className={`relative flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-xl cursor-pointer transition-all duration-300 overflow-hidden group ${
                                        previewUrl
                                            ...
                                            : "border-gray-700 hover:border-cyan-500/50 bg-black/20 hover:bg-cyan-950/10"
                                    }`}
                                >
                                            ...
                                            <div className="bg-gradient-to-br from-gray-800/70 to-gray-900/90 rounded-xl p-6 border border-gray-700/50 shadow-lg">
                                                <div className="flex items-center justify-center">
                                                    <div className="w-full max-w-md">
                                                        <div className="bg-gradient-to-b from-gray-100 to-gray-300 rounded-md p-4 shadow-inner text-center">
                                                            <div className="border-2 border-gray-800 rounded overflow-hidden bg-white p-2">
                                                                <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-1 mb-2 rounded">
                                                                    <p className="text-white text-xs font-bold">{ocrResults[0].corrected_province}</p>
                                                                </div>
                                                                <p className="text-black text-4xl font-bold tracking-wider font-mono">{ocrResults[0].plate}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mt-6">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="bg-gray-800/50 rounded-lg p-3 hover:bg-gray-800/80 transition-all duration-200">
                                                            <div className="flex items-center justify-between mb-1.5">
                                                                ...
                                                                <div className={`px-2 py-1 rounded text-xs font-semibold ${
                                                                    ocrResults[0].number_confidence > 85
                                                                        ? 'bg-gradient-to-r from-emerald-500 to-green-600 text-white'
                                                                        : ocrResults[0].number_confidence > 70
                                                                            ? 'bg-gradient-to-r from-amber-500 to-yellow-600 text-white'
                                                                            : 'bg-gradient-to-r from-red-500 to-rose-600 text-white'
                                                                }`}>
                                                                    {ocrResults[0].number_confidence.toFixed(1)}%
                                                                </div>
                                                            </div>
                                                            <div className="w-full h-1.5 bg-gray-900/80 rounded-full mt-1 overflow-hidden">
                                                                <div className={`h-full rounded-full ${
                                                                    ocrResults[0].number_confidence > 85
                                                                     ...
                                                                     style={{ width: `${ocrResults[0].number_confidence}%` }} />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="bg-gray-800/50 rounded-lg p-3 hover:bg-gray-800/80 transition-all duration-200">
                                                            <div className="flex items-center justify-between mb-1.5">
                                                                ...
                                                                <div className={`px-2 py-1 rounded text-xs font-semibold ${
                                                                    ocrResults[0].province_confidence > 85
                                                                        ? 'bg-gradient-to-r from-indigo-500 to-purple-600 text-white'
                                                                        : ocrResults[0].province_confidence > 70
                                                                            ? 'bg-gradient-to-r from-amber-500 to-yellow-600 text-white'
                                                                            : 'bg-gradient-to-r from-red-500 to-rose-600 text-white'
                                                                }`}>
                                                                    {ocrResults[0].province_confidence.toFixed(1)}%
                                                                </div>
                                                            </div>
                                                            <div className="w-full h-1.5 bg-gray-900/80 rounded-full mt-1 overflow-hidden">
                                                                <div className={`h-full rounded-full ${
                                                                    ocrResults[0].province_confidence > 85
                                                                     ...
                                                                     style={{ width: `${ocrResults[0].province_confidence}%` }} />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="bg-gray-800/50 rounded-lg p-3 hover:bg-gray-800/80 transition-all duration-200">
                                                            <div className="flex items-center justify-between">
                                                                ...
                                                                <div className="text-white text-xs font-semibold">
                                                                    {ocrResults[0].corrected_province}
                                                                </div>
                                                            </div>
                                                            ...
                                                            {ocrResults[0].detected_province !== ocrResults[0].corrected_province && (
                                                                <div className="mt-1 flex items-center justify-end">
                                                                    <p className="text-xs text-amber-400">
                                                                        Detected: {ocrResults[0].detected_province}
                                                                    </p>
                                                                </div>
                                                            )}
                                                        </div>
                                                    ...
                                                    <div className="mt-4 bg-gray-800/70 rounded-lg p-4 border border-gray-700/30">
                                                        <div className="flex items-center justify-between mb-1">
                                                            ...
                                                            {(() => {
                                                                const overallConfidence = (ocrResults[0].province_confidence + ocrResults[0].number_confidence) / 2;
                                                                let confidenceClass = '';
                                                                let confidenceLabel = '';

                                                                if (overallConfidence > 85) {
                                                                    confidenceClass = 'bg-gradient-to-r from-emerald-500 to-cyan-600';
                                                                    confidenceLabel = 'High';
                                                                } else if (overallConfidence > 70) {
                                                                    confidenceClass = 'bg-gradient-to-r from-amber-500 to-yellow-600';
                                                                    confidenceLabel = 'Medium';
                                                                } else {
                                                                    confidenceClass = 'bg-gradient-to-r from-red-500 to-rose-600';
                                                                    confidenceLabel = 'Low';
                                                                }
                                                                ...
                                                                return (
                                                                    <div className="flex items-center">
                                                                        ...
                                                                        <span className={`px-2 py-1 rounded text-xs font-semibold text-white ${confidenceClass}`}>
                                                                            {confidenceLabel}
                                                                        </span>
                                                                    </div>
                                                                );
                                                        ...
                                                        <div className="w-full h-2 bg-gray-900/70 rounded-full mt-2 overflow-hidden">
                                                            {(() => {
                                                                ...
                                                                return (
                                                                    <div
                                                                        className={`h-full ${confidenceClass} rounded-full shadow-inner transition-all duration-500`}
                                        ...
                                        <div className="mt-auto">
                                            ...
                                            <div className="flex space-x-4 pb-2 overflow-x-auto hide-scrollbar">
                                                {results.map((path, i) => {
                                                    ...
                                                    const labels = ["Detection", "Cropped Plate", "Numbers Only", "Province"];
                        ...
                        <div className="relative max-w-4xl w-full mx-4">
                            ...
                            <div className="mt-4 text-center">
                                <p className="text-white text-lg font-medium">
                                    {["Detection", "Cropped Plate", "Numbers Only", "Province"][validIndices[activeImageIndex]]}
                                </p>
                            </div>
                        </div>
                    </div>
