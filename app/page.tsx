      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
        ...
        <main className="container mx-auto px-4 py-12">
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
              <span className="w-1.5 h-8 bg-cyan-500 rounded mr-3" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  {ocrResults && (
                      <div className="bg-gray-900/80 rounded-xl shadow-2xl p-6 flex flex-col min-h-[300px]">
                        <h3 className="text-lg font-semibold text-cyan-400 mb-4 self-start">
                          OCR Analysis
                        </h3>
        ...
        <footer className="bg-gray-950 py-6 border-t border-gray-800/50">
          <div className="container mx-auto px-4 text-center text-gray-400 text-sm">
            <p>
              © {new Date().getFullYear()} PlateDetect AI • License Plate
              Recognition System
            </p>
